...
for required_file in \
  ...
  docs/todo-active-work-lifecycle/open-questions.md; do
...
grep -Fq -- '<!-- Generated by ai-first 1.1.0.' AGENTS.md ||
  fail "AGENTS.md generated boundary is missing"
grep -Fq -- '<!-- Generated by ai-first 1.1.0.' docs/agent-harness.md ||
