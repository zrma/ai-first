...
- 현재 active milestone은 `docs/todo-vcs-closeout-permission-continuity/`다. local
  logical change closeout과 bounded-task publication authorization을 `v1.2.0` release와
  소비 저장소 evidence까지 검증한 뒤 completed history로 이동한다.
