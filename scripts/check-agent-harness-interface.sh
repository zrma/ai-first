...
for required_file in \
  ...
  docs/milestones/vcs-closeout-permission-continuity/open-questions.md \
  docs/milestones/contract-audit-hardening/spec.md \
  docs/milestones/contract-audit-hardening/open-questions.md; do
...
grep -Fq -- '<!-- Generated by ai-first 1.3.0-dev.' AGENTS.md ||
  fail "AGENTS.md generated boundary is missing"
grep -Fq -- '<!-- Generated by ai-first 1.3.0-dev.' docs/agent-harness.md ||
